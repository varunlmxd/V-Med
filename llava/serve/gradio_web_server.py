...
title_markdown = ("""
 # V-Med : A Large Language and Vision Assistant for Bio-Medicine
""")
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                with gr.Accordion("Parameters", open=False) as parameter_row:
                    ...
                    max_output_tokens = gr.Slider(minimum=0, maximum=1024, value=64, step=64, interactive=True, label="Max output tokens",)
